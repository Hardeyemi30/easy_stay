...
//   return (
//     <div className="max-w-xl  bg-blue-800 text-white p-6 rounded-2xl shadow-md gap-x-5 justify-between">
//       <h1 className="text-2xl font-bold mb-6 text-white">Add Property</h1>

//       <form onSubmit={handleSubmit} className="space-y-6 justify-between gap-y-5">
//         <input
//           type="text"
//           name="title"
...
//         <button
//           type="submit"
//           className="w-full bg-blue-600 text-white p-3 rounded font-bold hover:bg-blue-700 mt-10"
//         >
//           Add Property
//         </button>
//       </form>
