...
export default function Dashboard() {
  ...
  const averageRating = properties.length > 0
    ? (properties.reduce((sum, property) => sum + property.rating, 0) / properties.length).toFixed(1)
    : "0.0";
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">Manage your property listings and track performance</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
          ...
          {properties.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-6">Start building your portfolio by adding your first property listing.</p>
              <a
                href="/add-property"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {properties.map((property) => (
                <div key={property.id} className="transform hover:scale-105 transition-transform duration-200">
                  <PropertyCard property={property} className="text-black shadow-md hover:shadow-lg" />
                </div>
              ))}
            </div>
          )}
